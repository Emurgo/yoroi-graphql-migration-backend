...
export async function getCurrentPrice(db: Pool, fromCurrency: string, logger: Logger): Promise<Ticker | undefined> {
...
export async function getHistoricalPrice(db: Pool, fromCurrency: string, timestamps: Array<number>, logger: Logger): Promise<Array<Ticker>> {
